...
<body>
    <div class="post js_watermark quill-editor dark:!bg-[#20242A]">
        <h1 class="title title-mark dark:!text-slate-300">中国海洋大学，改考408！</h1>
        ...
        <div class="author-info">
            ...
            <span class="date" id="article-date">2023年09月14日 23:05</span>
        </div>
        <div class="ql-snow">
            <div class="content ql-editor"><p><span style="background-color: rgb(255, 255, 255); font-size: 15px; color: rgb(47, 48, 52);">hello大家好，我是全全~又有一所学校改考408啦</span></p><p><span style="font-size: 15px; background-color: rgb(255, 215, 213);">​中国海洋大学-信息科学与工程学部</span></p><p><img src="https://article-images.zsxq.com/FixeyHj6Z4iEpIXyBUmHjbZIAFVZ"></p><p><br></p></div>
        </div>
