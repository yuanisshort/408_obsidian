...
<body>
    <div class="post js_watermark quill-editor dark:!bg-[#20242A]">
        <h1 class="title title-mark dark:!text-slate-300">24考研机试模拟---xjtu机试改编</h1>
        ...
        <div class="author-info">
            ...
            <span class="date" id="article-date">2024年02月02日 17:04</span>
        </div>
        <div class="ql-snow">
            <div class="content ql-editor"><p><img src="https://article-images.zsxq.com/FqYQWnkKzbRP1q9OIzLUyKvJdeqw"></p><p><strong style="color: rgb(204, 0, 0);">上面的题考察内容是比较全面的！大家可以把解法用文字或者截图打在评论区！过两天我会公布答案！</strong></p></div>
        </div>
        <div class="milkdown-preview"><p><img src="https://article-images.zsxq.com/FqYQWnkKzbRP1q9OIzLUyKvJdeqw"></p><p><strong style="color: rgb(204, 0, 0);">上面的题考察内容是比较全面的！大家可以把解法用文字或者截图打在评论区！过两天我会公布答案！</strong></p></div>
        <footer>
