...
<head>
    ...
    <title>中央财经大学细分电子信息、改考408</title>
...
<body>
    <div class="post js_watermark quill-editor dark:!bg-[#20242A]">
        <h1 class="title title-mark dark:!text-slate-300">中央财经大学细分电子信息、改考408</h1>
        ...
        <div class="author-info">
            ...
            <span class="date" id="article-date">2023年09月16日 11:09</span>
        </div>
        <div class="ql-snow">
            <div class="content ql-editor"><p><img src="https://article-images.zsxq.com/FoPTuyoraa0sRkYZgIEhRPFKQR8C"></p></div>
        </div>
        <div class="milkdown-preview"><p><img src="https://article-images.zsxq.com/FoPTuyoraa0sRkYZgIEhRPFKQR8C"></p></div>
        <footer>
