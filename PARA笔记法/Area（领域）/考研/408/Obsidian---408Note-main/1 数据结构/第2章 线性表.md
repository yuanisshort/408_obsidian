...
![线性表的定义和基本操作.pdf](01.2.1_线性表的定义和基本操作.pdf)
...
![顺序表的定义.pdf](01.2.2.1_顺序表的定义.pdf)
...
![顺序表的插入删除.pdf](02.2.2.2_1_顺序表的插入删除.pdf)
...
![顺序表的查找.pdf](03.2.2.2_2_顺序表的查找.pdf)
### 按位查找
...
![单链表的定义.pdf](01.2.3.1_单链表的定义.pdf)
...
![单链表的插入删除.pdf](02.2.3.2_1_单链表的插入删除.pdf)
### 单链表的插入
...
![单链表的查找.pdf](03.2.3.2_2_单链表的查找.pdf)
### 单链表的查找
...
![单链表的建立.pdf](04.2.3.2_3_单链表的建立.pdf)
...
![顺序表和链表的比较.pdf](08.2.3.6_顺序表和链表的比较.pdf)
...
* 顺序表
	* 按位查找：$O(1)$
	* 按值查找：$O(n)$，若表内元素有序，可在 $O(\log_{2}n)$ 时间内找到(如[折半查找](第7章%20查找.md#7.2.2%20折半查找))
* 链表：
	* 按位查找：$O(n)$
	* 按值查找：$O(n)$
