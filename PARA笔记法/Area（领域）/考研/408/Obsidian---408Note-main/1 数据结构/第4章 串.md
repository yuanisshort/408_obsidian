...
![串的定义和基本操作.pdf](01.4.1.1_串的定义和基本操作.pdf)
...
![串的存储结构.pdf](02.4.1.2_串的存储结构.pdf)
...
注：结合[链表](第2章%20线性表.md#2.3.6%20顺序表和链表的比较)思考优缺点
...
![朴素模式匹配算法.pdf](01.4.2.1_朴素模式匹配算法.pdf)
...
![KMP算法.pdf](02.4.2.2_1_KMP算法.pdf)
...
![第4章 串-KMP算法.drawio](第4章%20串-KMP算法.drawio.svg)

### 预处理求 `next` 数组

> 会手算即可

![求next数组.pdf](03.4.2.2_2_求next数组.pdf)
...
![第4章 串-KMP算法求next数组.drawio](第4章%20串-KMP算法求next数组.drawio.svg)
...
![KMP算法的进一步优化.pdf](04.4.2.3_KMP算法的进一步优化.pdf)
