...
![栈的基本概念.pdf](01.3.1.1_栈的基本概念.pdf)
...
![栈的顺序存储实现.pdf](02.3.1.2_栈的顺序存储实现.pdf)
...
![栈的链式存储实现.pdf](03.3.1.3_栈的链式存储实现.pdf)
...
> 参考：[单链表上基本操作的实现](第2章%20线性表.md#2.3.2%20单链表上基本操作的实现)
...
**进栈操作**：即使用[头插法](第2章%20线性表.md#头插法建立单链表)插入结点
...
![队列的基本概念.pdf](01.3.2.1_队列的基本概念.pdf)
...
![队列的顺序实现.pdf](02.3.2.2_队列的顺序实现.pdf)
...
![队列的链式实现.pdf](03.3.2.3_队列的链式实现.pdf)
...
![栈在括号匹配中的应用.pdf](01.3.3.1_栈在括号匹配中的应用.pdf)
...
![栈在表达式求值中的应用(上).pdf](02.3.3.2_1_栈在表达式求值中的应用(上).pdf)


![栈在表达式求值中的应用(下).pdf](03.3.3.2_2_栈在表达式求值中的应用(下).pdf)
...
![栈在递归中的应用.pdf](04.3.3.3_栈在递归中的应用.pdf)
...
![队列的应用.pdf](05.3.3.4+3.3.5_队列的应用.pdf)

## 3.3.1 树的层次遍历

详见[树的层序遍历](第5章%20树与二叉树.md#树的层序遍历)

## 3.3.2 图的广度优先遍历

详见[广度优先遍历BFS](第6章%20图.md#6.3.1%20广度优先遍历BFS)

## 3.3.3 队列在操作系统中的应用

* CPU资源分配，[先来先服务(FCFS)](第2章%20进程与线程.md#先来先服务(FCFS))中采用就绪进程队列
* 打印数据缓冲区，[SPOOLing技术](第5章%20输入输出管理.md#5.2.4%20SPOOLing技术（假脱机技术）)中采用缓冲区队列
...
![特殊矩阵的压缩存储.pdf](01.3.4.1~3.4.4_特殊矩阵的压缩存储.pdf)
