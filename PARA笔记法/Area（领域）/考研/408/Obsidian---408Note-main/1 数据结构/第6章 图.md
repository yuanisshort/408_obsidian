...
![屏幕截图 2024-11-30 170051](D:\学习资料\考研\计算机\Resource（资源）\Obsidian---408Note-main\Obsidian---408Note-main\1 数据结构\第6章 图.assets\屏幕截图 2024-11-30 170051.png)

![图的基本概念.pdf](01.6.1.1图的基本概念.pdf)
...
* 适合用于存储稠密图。<!--能存储更多的元素-->
* 无向图的邻接矩阵是对称矩阵，可以[压缩存储](第3章%20栈和队列.md#3.4.3%20特殊矩阵的存储)（只存储上三角区或者下三角区）。
...
![十字链表、邻接多重表.pdf](03.6.2.3+6.2.4十字链表、邻接多重表.pdf)
...
![图的广度优先遍历.pdf](01.6.3.1图的广度优先遍历.pdf)

广度优先遍历（Breadth-First-Search, BFS），可以与[树的广度优先遍历（层次遍历）](第5章%20树与二叉树.md#树的层序遍历)相联系。要点如下：
* 找到与一个顶点相邻的所有顶点；
...
![图的深度优先遍历.pdf](02.6.3.2图的深度优先遍历.pdf)

深度优先遍历（Deepth-First-Search, DFS），可以与[树的先序遍历](第5章%20树与二叉树.md#树的先根遍历)相联系
...
实现思想
* 将各条边按权值排序
* 依次检查每条边的两个顶点是否连通（是否属于同一个集合）——[并查集](第5章%20树与二叉树.md#5.5.2%20并查集)。不连通就连起来，已连通就跳过
...
![BFS算法.pdf](02.6.4.2_1最短路径问题_BFS算法.pdf)
...
![Dijkstra算法.pdf](03.6.4.2_2最短路径问题_Dijkstra算法.pdf)
...
3. 实现思想（类似[Prim 算法](#Prim算法) ^[注：[Prim算法和Dijkstra算法的区别](Prim算法和Dijkstra算法的区别.md)]）
...
![Floyd算法.pdf](04.6.4.2_3最短路径问题_Floyd算法.pdf)
...
![有向无环图描述表达式.pdf](05.6.4.3有向无环图描述表达式.pdf)
...
> ![第6章 图-番茄炒蛋工程.drawio](第6章%20图-番茄炒蛋工程.drawio.svg)
